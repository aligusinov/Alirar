...
// Windows için unrar kontrolü
bool checkUnrar() {
#ifdef _WIN32
    QProcess process;
    process.start("where", QStringList() << "unrar");
    process.waitForFinished();
    if (process.exitCode() != 0) {
        QMessageBox::warning(nullptr, "Uyarı", 
            "unrar bulunamadı!\n\n"
            "Windows için unrar'ı buradan indirin:\n"
            "https://www.rarlab.com/rar/winrar-x64-701tr.exe\n\n"
