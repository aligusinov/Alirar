#############################################################################
# Makefile for building: Alirar
# Generated by qmake (3.1) (Qt 6.4.2)
# Project:  Alirar.pro
# Template: app
# Command: /usr/bin/qmake6 -o Makefile Alirar.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = Alirar1.0.0
DISTDIR = /home/ali/Alirar/.tmp/Alirar1.0.0
LINK          = g++
...
SOURCES       = main.cpp \
		settingsdialog.cpp moc_settingsdialog.cpp
OBJECTS       = main.o \
		settingsdialog.o \
...
Makefile: Alirar.pro /usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents settings.h settingsdialog.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp settingsdialog.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_settingsdialog.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_settingsdialog.cpp
moc_settingsdialog.cpp: settingsdialog.h \
		moc_predefs.h \
		/usr/lib/qt6/libexec/moc
	/usr/lib/qt6/libexec/moc $(DEFINES) --include /home/ali/Alirar/moc_predefs.h -I/usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++ -I/home/ali/Alirar -I/usr/include/x86_64-linux-gnu/qt6 -I/usr/include/x86_64-linux-gnu/qt6/QtWidgets -I/usr/include/x86_64-linux-gnu/qt6/QtGui -I/usr/include/x86_64-linux-gnu/qt6/QtCore -I/usr/include/c++/13 -I/usr/include/x86_64-linux-gnu/c++/13 -I/usr/include/c++/13/backward -I/usr/lib/gcc/x86_64-linux-gnu/13/include -I/usr/local/include -I/usr/include/x86_64-linux-gnu -I/usr/include settingsdialog.h -o moc_settingsdialog.cpp
